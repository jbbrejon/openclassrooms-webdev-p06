...
// Set variable : token string for 'sign()' method of jsonwebtoken module
...
module.exports = (req, res, next) => {
    try {
        ...
        res.status(401).json({ error: error | 'Request not authenticated!' }); // If error -> return status code 201 with error message  (https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/401)
    }
};